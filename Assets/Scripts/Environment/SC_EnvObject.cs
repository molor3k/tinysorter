...
public class SC_EnvObject : MonoBehaviour {
    ...
    public void DropItemOnFreeCell() {
        ...
        gameObject.transform.position = playerObject.transform.position + new Vector3(0.0f, 2.0f, 0.0f);
        gameObject.GetComponent<SC_Item>().targetPosition = new Vector3(firstFreeCellWorldPos.x, playerPos.y + .5f, firstFreeCellWorldPos.z);
